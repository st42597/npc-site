  ...
  return(
    <div className="main">
      <div className="frame-01">
        <img src="/pics/main_1.png" alt="main_1" style={{height: "70%"}} />
        <div className="row text-box align-items-center" style={{height: "30%", padding: "0 15vw"}}>
          ...
          <div className="col-6 p-0 text-right">
            <p className="text-md">성균관대 소프트웨어대학</p>
            <p className="text-md">알고리즘 문제해결(PS) 동아리</p>
          </div>
        </div>
      </div>

      <div className="frame-02">
        <div className="row text-box align-items-center">
          <div className="mb-5 p-0 text-left">
            <p className="text-xl">NPC는</p>
            <p className="text-xl">알고리즘 문제해결(PS) 동아리입니다.</p>
          </div>
        </div>
        <div className="row justify-content-center">
          <div className="my-auto col-md-6 col-12 p-0 pr-md-5 text-left text-thin">
            <p className="text-xs">NPC는 2011년에 정보통신대학 소속 알고리즘 연구회로 활동을 시작해, 다양한 알고리즘 관련 활동을 이어오고 있습니다.</p>
            <br></br>
            <p className="text-xs">많은 기업에서 코딩테스트를 도입하는 등 PS의 중요성은 잘 알려져 있습니다. 알고리즘 문제해결은 소프트웨어 엔지니어링의 핵심 능력을 키우기에 가장 좋은 활동 중 하나입니다.</p>
          </div>
      ...
      <div className="frame-03">
        <div className="mb-5">
          <p className="text-xl text-left">NPC는 알고리즘 경시대회를 준비합니다.</p>
        </div>
        <div className="col background" style={{ backgroundImage: 'url(/pics/main_3.png)' }}>
          <div className="text-box vertical-center p-0">
            <div className="white">
              <p className="text-lg horizontal-center mb-5">1. 다양한 프로그래밍 경시대회 참가</p>
              <br />
